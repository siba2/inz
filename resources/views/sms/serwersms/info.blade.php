                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('t_serwersms.serwersms.info.countsms') }}</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">{{ __('t_serwersms.serwersms.info.pkt') }}</span>
...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <center><h3 class="box-title">{{ __('t_serwersms.serwersms.info.sms') }}</h3></center>
