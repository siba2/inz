<div class="col-xs-5">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ __('t_smsapi.smsapi.form.header.serwersms') }}</h3>
        </div>
        <!-- /.box-header -->
        {{ csrf_field() }}
        <div class="box-body">
            <div class="form-group {{ ($errors->has('phone') ? 'has-error' : '') }}">
                <label for="phone">{{ __('t_smsapi.smsapi.form.label.phone') }}*</label>
            ...
            <div class="form-group {{ ($errors->has('phone') ? 'has-error' : '') }}">
                <label for="text">{{ __('t_smsapi.smsapi.form.label.text') }}*</label>
